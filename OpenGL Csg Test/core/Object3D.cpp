 ...
 */
Vertex * Object3D::addVertex(const Vector & pos, const Color & color, int status)
{
	int i;
...
void Object3D::splitFace(int facePos, Segment & segment1, Segment & segment2)
{
	...
	{
		Vector segmentVector(startPos.x-endPos.x, startPos.y-endPos.y, startPos.z-endPos.z);
		...
		Vector vertexVector(endPos.x-face.v1->x, endPos.y-face.v1->y, endPos.z-face.v1->z);
		vertexVector.Normalise();
		//double dot1 = fabs(segmentVector.dot(vertexVector));
		double dot1 = fabs(segmentVector * vertexVector);
		vertexVector = Vector(endPos.x-face.v2->x, endPos.y-face.v2->y, endPos.z-face.v2->z);
		vertexVector.Normalise();
		//double dot2 = fabs(segmentVector.dot(vertexVector));
		double dot2 = fabs(segmentVector * vertexVector);
		vertexVector = Vector(endPos.x-face.v3->x, endPos.y-face.v3->y, endPos.z-face.v3->z);
		vertexVector.Normalise();
 ...
 */		
void Object3D::breakFaceInTwo(int facePos, const Vector & newPos, int splitEdge)
{
 ...
 */		
void Object3D::breakFaceInTwo(int facePos, const Vector & newPos, Vertex & endVertex)
{
	Face & face = *faces->GetFace(facePos);
 ...
 */
void Object3D::breakFaceInThree(int facePos, const Vector & newPos1, const Vector & newPos2, int splitEdge)
{
 ...
 */
void Object3D::breakFaceInThree(int facePos, const Vector & newPos, Vertex & endVertex)
{
	Face & face = *(faces->get(facePos));
	// Moved remove to the end
	//faces->remove(facePos);
 ...
 */
void Object3D::breakFaceInThree(int facePos, const Vector & newPos1, const Vector & newPos2, Vertex & startVertex, Vertex & endVertex)
{
	Face & face = *(faces->get(facePos));
	// Moved remove to the end
	//faces->remove(facePos);
 ...
 * @param newPos new vertex position
 */
void Object3D::breakFaceInThree(int facePos, const Vector & newPos)
{
	Face & face = *(faces->get(facePos));
	// Moved remove to the end
	//faces->remove(facePos);
 ...
 * @param endVertex vertex used for the split
 */	
void Object3D::breakFaceInFour(int facePos, const Vector & newPos1, const Vector & newPos2, Vertex & endVertex)
{
	Face & face = *(faces->get(facePos));
	// Moved remove to the end
	//faces->remove(facePos);
 ...
 */		
void Object3D::breakFaceInFive(int facePos, const Vector & newPos1, const Vector & newPos2, int linedVertex)
{
	Face & face = *(faces->get(facePos));
