...
Vertex::Vertex(const Vector & position, const Color & colori)
{
...
Vertex::Vertex(const Vector & position, const Color & colori, int status)
{
	color.red = colori.red;
	color.green = colori.green;
	color.blue = colori.blue;
...
Vertex::Vertex(double x, double y, double z, const Color & colori)
{
	color.red = colori.red;
	color.green = colori.green;
	color.blue = colori.blue;
...
Vertex::Vertex(double x, double y, double z, const Color & colori, int status)
{
	color.red = colori.red;
	color.green = colori.green;
	color.blue = colori.blue;
