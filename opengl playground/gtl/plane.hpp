...
namespace gtl
{
    ...
    */
    ...
    public:
		...
		/////////////////////////////////////////////////////
		//when the points are in xoz plane
		// 	RVec3Array path;
		//	path.push_back( RVec3(0.0f, 0.0f, 0.0f) );
		//	path.push_back( RVec3(1.0f, 0.0f, 1.0f) );
		//	path.push_back( RVec3(1.0f, 0.0f, 2.0f) );
		//	path.push_back( RVec3(2.0f, 0.0f, 3.0f) );
		/////////////////////////////////////////////////////
