...
// Version     : 1.0
// Description : Drawing a Lit Torus With A Rotating Light
//
//------------------------------------------------------------------------
program OpenGLApp;
...
const
  WND_TITLE = 'Drawing a Lit Torus With A Rotating Light by McCLaw (RedBook)';
  ...
  light_ambient :array [0..3] of GLfloat = ( 0.0, 0.0, 1.0, 1.0 ); // Define some ambient light to add to the scene
var
...
begin
  ...
  glPushMatrix();
    ...
    glPopMatrix();
    glCallList(TorusDL); // Render the Torus to the scene
  glPopMatrix;
