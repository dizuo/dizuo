...
void    ConvexHull3D::DoubleTriangle( void )
{
	...
	v0 = vertices;
	while ( Collinear( v0, v0->next, v0->next->next ) )	//判断是否共线
	...
	/* Find a fourth, noncoplanar point to form tetrahedron(四面体). */
	v3 = v2->next;
	...
	vertices = v3;	//修改了vertices的值，为接下来的工作铺垫
...
It first determines all faces visible from 
that point.  If none are visible then the point is marked as not 
onhull.  
Next is a loop over edges.  If both faces adjacent to an edge
